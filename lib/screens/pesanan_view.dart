...
class PesananView extends StatefulWidget {
  ...
  const PesananView({super.key, required this.appState, required this.onRefresh});
                          ...
                          PopupMenuButton<String>(
                            ...
                            onSelected: (newStatus) {
                              if (newStatus != o.status) {
                                ...
                                if (idx != -1) {
                                  setState(() {
                                    widget.appState.orders[idx] = o.copyWith(status: newStatus);
                                  });
                                  widget.onRefresh();
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('Status pesanan ${o.id} diperbarui menjadi $newStatus', style: GoogleFonts.inter()), backgroundColor: const Color(0xFF2E7D32)),
                                  );
                                }
                              }
                            },
